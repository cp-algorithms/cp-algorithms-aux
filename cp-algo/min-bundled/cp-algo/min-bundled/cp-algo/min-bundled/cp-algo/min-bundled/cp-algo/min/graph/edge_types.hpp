#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/min/graph/edge_types.hpp"
#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/min/graph/edge_types.hpp"
#line 1 "cp-algo/min-bundled/cp-algo/min/graph/edge_types.hpp"
