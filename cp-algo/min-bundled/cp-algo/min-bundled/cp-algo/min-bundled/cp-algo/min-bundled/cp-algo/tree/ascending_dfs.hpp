#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/tree/ascending_dfs.hpp"
#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/tree/ascending_dfs.hpp"
#line 1 "cp-algo/min-bundled/cp-algo/tree/ascending_dfs.hpp"
