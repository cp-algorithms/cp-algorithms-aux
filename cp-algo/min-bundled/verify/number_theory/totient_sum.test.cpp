#line 1 "verify/number_theory/totient_sum.test.cpp"
...
#line 5 "cp-algo/util/big_alloc.hpp"
#include <cstddef>
...
#line 9 "verify/number_theory/totient_sum.test.cpp"
#include <bits/stdc++.h>
using namespace std;
...
cin>>n;
auto H=floors(n)|views::transform([](int64_t k){return base(k)*base(k+1)/2;})|ranges::to<vector>();
auto G=floors(n)|views::transform([](int64_t k){return base(k);})|ranges::to<vector>();
