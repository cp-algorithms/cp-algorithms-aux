#line 1 "cp-algo/min-bundled/cp-algo/min/min-bundled/cp-algo/number_theory/dirichlet.hpp"
#line 1 "cp-algo/min/min-bundled/cp-algo/number_theory/dirichlet.hpp"
