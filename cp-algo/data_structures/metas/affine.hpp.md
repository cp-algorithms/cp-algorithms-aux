...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"cp-algo/data_structures/metas/affine.hpp\"\n\n\n#line 1\
    ...
    \ int, int) override {\n                    sum = L.sum + R.sum;\n           \
    \     }\n            };\n        }\n    }\n}\n\n"
  code: "#ifndef DATA_STRUCTURES_METAS_AFFINE_HPP\n#define DATA_STRUCTURES_METAS_AFFINE_HPP\n\
    #include \"base.hpp\"\nnamespace data_structures {\n    namespace segment_tree\
    \ {\n        namespace metas {\n            template<typename base>\n        \
    \    struct affine_meta: base_meta<affine_meta<base>> {\n                using\
    \ meta = affine_meta;\n                struct lin {\n                    base\
    ...
    \  sum = L.sum + R.sum;\n                }\n            };\n        }\n    }\n\
    }\n#endif // DATA_STRUCTURES_METAS_AFFINE_HPP"
  dependsOn:
  - cp-algo/data_structures/metas/base.hpp
...
documentation_of: cp-algo/data_structures/metas/affine.hpp
layout: document
redirect_from:
- /library/cp-algo/data_structures/metas/affine.hpp
- /library/cp-algo/data_structures/metas/affine.hpp.html
