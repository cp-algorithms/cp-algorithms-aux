...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"cp-algo/data_structures/metas/chmin_chmax_add.hpp\"\n\n\n\
    ...
    \        };\n        }\n    }\n}\n\n"
  code: "#ifndef DATA_STRUCTURES_METAS_CHMIN_CHMAX_ADD_HPP\n#define DATA_STRUCTURES_METAS_CHMIN_CHMAX_ADD_HPP\n\
    #include \"base.hpp\"\n#include <functional>\n#include <algorithm>\n#include <cstdint>\n\
    namespace data_structures {\n    namespace segment_tree {\n        namespace metas\
    \ {\n            struct chmin_chmax_sum_meta: base_meta<chmin_chmax_sum_meta>\
    \ {\n                static constexpr int64_t inf = 1e12;\n\n                using\
    ...
    \  }\n                static auto stop_chmax(int64_t b) {\n                  \
    \  return [b](meta const& t) {return t.mn.stop(b);};\n                }\n    \
    \        };\n        }\n    }\n}\n#endif // DATA_STRUCTURES_METAS_CHMIN_CHMAX_ADD_HPP"
  dependsOn:
...
documentation_of: cp-algo/data_structures/metas/chmin_chmax_add.hpp
layout: document
redirect_from:
- /library/cp-algo/data_structures/metas/chmin_chmax_add.hpp
- /library/cp-algo/data_structures/metas/chmin_chmax_add.hpp.html
