#line 1 "verify/graph/minimum_diameter_spanning_tree.test.cpp"
...
#line 1 "cp-algo/tree/diameter.hpp"
...
#line 5 "cp-algo/tree/diameter.hpp"
#include <tuple>
#include <string>
#line 8 "cp-algo/tree/diameter.hpp"
...
#line 8 "verify/graph/minimum_diameter_spanning_tree.test.cpp"
#include <bits/stdc++.h>
using namespace std;
using namespace cp_algo::graph;
template<weighted_undirected_graph_type graph>
auto minimum_diameter_spanning_tree(graph const&g){int64_t min_diameter=shortest_path_context::inf;
std::vector<edge_index>best_edges;
for(auto v:g.nodes()){auto[_,p]=dijkstra(g,v);
auto d=tree_diameter(g,&p);
if(d<min_diameter){min_diameter=d;
best_edges=p;}}
