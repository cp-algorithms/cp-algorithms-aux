#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/graph/euler.hpp"
#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/graph/euler.hpp"
