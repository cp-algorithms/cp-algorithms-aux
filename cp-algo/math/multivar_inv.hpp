...
namespace cp_algo::math::fft {
    // Compute inverse of multivariate formal power series using Newton iteration
    // Requires: a.data[0] is invertible
    // Returns: b such that a * b = 1 (mod truncation)
...
#endif // CP_ALGO_MATH_MULTIVAR_INV_HPP
