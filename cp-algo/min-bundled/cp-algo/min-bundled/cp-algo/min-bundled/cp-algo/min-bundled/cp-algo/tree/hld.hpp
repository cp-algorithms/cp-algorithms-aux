#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/tree/hld.hpp"
#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/tree/hld.hpp"
