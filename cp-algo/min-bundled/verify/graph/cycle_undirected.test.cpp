#line 1 "verify/graph/cycle_undirected.test.cpp"
...
#line 5 "verify/graph/cycle_undirected.test.cpp"
#include <bits/stdc++.h>
using namespace std;
...
if(empty(cycle)){cout<<-1<<"\n";}else{cout<<size(cycle)<<"\n";
cout<<v;
for(auto it:cycle|views::take(size(cycle)-1)){v=g.edge(it).traverse(v);
cout<<' '<<v;}
cout<<"\n";
