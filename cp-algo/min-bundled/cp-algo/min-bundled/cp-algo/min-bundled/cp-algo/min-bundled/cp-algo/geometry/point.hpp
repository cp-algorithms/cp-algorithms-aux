#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/geometry/point.hpp"
#line 1 "cp-algo/min-bundled/cp-algo/min-bundled/cp-algo/geometry/point.hpp"
