#line 1 "cp-algo/min-bundled/cp-algo/min/min-bundled/cp-algo/structures/stack_union.hpp"
#line 1 "cp-algo/min/min-bundled/cp-algo/structures/stack_union.hpp"
