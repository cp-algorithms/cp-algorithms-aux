...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"cp-algo/data_structures/metas/all.hpp\"\n\n\n#line 1 \"\
    ...
    \ = to_push * R->to_push;\n                        }\n                       \
    \ to_push = {};\n                    }\n                }\n\n                void\
    \ pull(meta const& L, meta const& R, int, int) override {\n                  \
    \  sum = L.sum + R.sum;\n                }\n            };\n        }\n    }\n\
    }\n\n#line 6 \"cp-algo/data_structures/metas/all.hpp\"\n\n"
  code: '#ifndef DATA_STRUCTURES_METAS_ALL_HPP

    #define DATA_STRUCTURES_METAS_ALL_HPP

    #include "chmin_chmax_add.hpp"

    #include "affine.hpp"

    #include "base.hpp"

    #endif // DATA_STRUCTURES_METAS_ALL_HPP'
  dependsOn:
  - cp-algo/data_structures/metas/chmin_chmax_add.hpp
  ...
  verifiedWith: []
documentation_of: cp-algo/data_structures/metas/all.hpp
layout: document
redirect_from:
- /library/cp-algo/data_structures/metas/all.hpp
- /library/cp-algo/data_structures/metas/all.hpp.html
